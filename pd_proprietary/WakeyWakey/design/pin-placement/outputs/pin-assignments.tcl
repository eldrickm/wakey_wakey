...
# Pins on the right side, top to bottom
set pins_right {\
    {io_oeb[14]}\
    {io_out[14]}\
    {io_in[14]}\
...
editPin -layer $left_right_ports_layer -pin $pins_left   -side LEFT   -spreadType SIDE
editPin -layer $top_bottom_ports_layer -pin $pins_bottom -side BOTTOM -spreadType SIDE
editPin -layer $top_bottom_ports_layer -pin $pins_top    -side TOP    -spreadType SIDE
