...
def construct():
  ...
  gl_sim.extend_inputs(['ifmap_data.txt'])
  gl_sim.extend_inputs(['weight_data.txt'])
  gl_sim.extend_inputs(['ofmap_data.txt'])
  gl_sim.extend_inputs(['layer_params.v'])
  ...
  for step in [pt_timing, pt_power_rtl, pt_power_gl]:
    step.extend_inputs(['sky130_sram_4kbyte_1rw1r_32x1024_8_TT_1p8V_25C.db',
  ...
  # g.connect( testbench.o( 'design.args'  ),     gl_sim.i( 'design.args'      ) )
  # g.connect( testbench.o( 'test_vectors.txt' ), gl_sim.i( 'test_vectors.txt' ) )
  g.connect_by_name(testbench, gl_sim);
